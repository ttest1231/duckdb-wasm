...
[![npm](https://img.shields.io/npm/v/duckdb-wasm-es?logo=npm)](https://www.npmjs.com/package/duckdb-wasm-es/v/latest)
[![JSDevlivr](https://data.jsdelivr.com/v1/package/npm/duckdb-wasm-es/badge?style=rounded)](https://www.jsdelivr.com/package/npm/duckdb-wasm-es)
...
import duckdb_wasm_next from 'duckdb-wasm-es/dist/duckdb-eh.wasm';
...
```ts
import * as duckdb from 'duckdb-wasm-es';
import duckdb_wasm from 'duckdb-wasm-es/dist/duckdb-mvp.wasm?url';
import mvp_worker from 'duckdb-wasm-es/dist/duckdb-browser-mvp.worker.js?url';
import duckdb_wasm_eh from 'duckdb-wasm-es/dist/duckdb-eh.wasm?url';
import eh_worker from 'duckdb-wasm-es/dist/duckdb-browser-eh.worker.js?url';
...
await db.instantiate(bundle.mainModule, bundle.pthreadWorker);
```
static served(manually download the files from https://cdn.jsdelivr.net/npm/duckdb-wasm-es/dist/)
```ts
import * as duckdb from 'duckdb-wasm-es';
